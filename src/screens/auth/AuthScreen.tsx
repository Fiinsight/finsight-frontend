...
export function AuthScreen({ onAuthenticated }: Props) {
  ...
  async function startKakao() {
    setBusy(true);
    try { await Linking.openURL(await getKakaoLoginUrl()); }
    catch (error: any) {
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: "#168DF2", paddingHorizontal: 28, justifyContent: "center" },
  ...
  primaryText: { color: "#168DF2", fontFamily: "Pretendard", fontSize: 15, fontWeight: "800" },
